...
public void i_want_to_compare_Gas_and_Electricity_prices() throws Throwable {
	Thread.sleep(5000);
    supplierPage.clickGasAndElectricityButton();
}
...
public void i_have_different_gas_and_electricity_suppliers() throws Throwable {
	//supplierPage.clickYesForGasAndElectricitySuppliersCheckbox();
    supplierPage.clickNoForGasAndElectricitySuppliersCheckbox();
}
}
